          ...
          <div className="min-h-screen flex items-center">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-4xl">
                <Badge variant="outline" className="bg-red-700/20 text-red-300 border-red-700/50 mb-6 backdrop-blur-sm px-3 py-2 text-xs sm:text-sm md:text-base inline-flex items-center flex-wrap">
                  <VerifiedIcon className="mr-2 h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 flex-shrink-0" />
                  <span className="break-words">Serving Wisconsin & Illinois Since 1996</span>
                </Badge>
